...
const AddProduct = () => {
  const handleAddProduct = e => {
    ...
    fetch('https://futuristix-tech-server-5fldsw6yr-jahid2121s-projects.vercel.app/products', {
      method: 'POST',
      headers: {
  ...
  return (
    <>
    <Navbar></Navbar>
    <div data-aos="fade-left" style={{backgroundImage: "url('https://i.ibb.co/khyLmT4/background-2426328.jpg')"}} className="bg-cover min-h-screen pb-8">
